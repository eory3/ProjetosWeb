...
<head>
	...
	<meta charset="utf-8">
	<link type="text/css" rel="stylesheet" href="visualizacao/css/bootstrap.min.css">
	<link type="text/css" rel="stylesheet" href="visualizacao/css/datatables.min.css">
	...
	<script type="text/javascript" charset="utf8" src="visualização/js/jquery.mask.min.js"></script>
		...
		<div id="accordion" style="margin-top: 10px;">
			...
			<div class="card">
				...
				<div id="tecnologiasCadastradas" class="collapse show">
					<div class="card-body">                     
						<table id="tabela" class="table table-hover" style="overflow: visible;">
							<thead>
							...
							<tbody>
								...
								<tr style="text-align: center;">
								<td style="padding-top: 30px;"><?php echo $row['id']; ?></td>
								...
								echo $semana[$semanaNumero];
								?></td>
								<td style="padding-top: 30px;"><?php echo $row['tempo']; ?></td>
								<td style="padding-top: 30px;"><?php echo $row['valor']."R$"; ?></td>
								<td>
									<!-- botoes -->
													...
													<div class="container">
														<form method="post" action="controlador/upPonto.php">
															<div class="form-group">
																...
																<input type="date"  class="form-control" id="data" name="dataPonto" 
																value="<?php  
																	$data = date_create($row['data']);
															...
															<div class="form-group">
																...
																<select class="form-control" name="tempoPonto" id="tempo" required>
																	<option value="">Selecione um tempo</option>
																	<?php 
																		if ($row['tempo'] == 'Um Dia') {
																			echo "<option value='Um Dia' selected>Um Dia</option>";
																			echo "<option value='Meio Dia'>Meio Dia</option>";
																		}
																		else if ($row['tempo'] == 'Meio Dia') {
																			echo "<option value='Meio Dia' selected>Meio Dia</option>";
																			echo "<option value='Um Dia'>Um Dia</option>";
																		}
																	 ?>
																</select>
															</div>
					...
					<tfoot>						
						<tr>
							<th colspan="6" style="text-align: left;"><?php echo "TOTAL: $total R$"; ?></th>
						</tr>
					</tfoot>
				</table>
				<!-- Button trigger modal -->
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<div class="container">
									...
									<form method="post" id="add" action="controlador/valPonto.php">
										<div class="form-group">
											<label for="data">Data:</label>
											<input type="date" placeholder="Selecione uma data" class="form-control" id="data" name="dataPonto" value="" required>
										</div>
										<div class="form-group">
											<label for="tempo">Tempo:</label>
											<select class="form-control" name="tempoPonto" id="tempo" required>
												<option value="" selected>Selecione um tempo</option>
