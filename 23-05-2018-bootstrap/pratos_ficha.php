...
<div class="row">
	<div class="col-md-12">
		...
		<div class="form-group">	
			...
			<input type="text" name="descricao" id="descricao" maxlength="100" size="60" value="<?php echo $descricao; ?>" placeholder="Informe uma descrição para o prato">
		...
		<div class="form-group">	
			...
			<input type="text" name="valor_unitario" id="valor_unitario" size="20" value="<?php echo $valor_unitario; ?>" placeholder="Valor unitário do prato">
